        ...
        <div class="h-full px-5 py-3">
            ...
            >
                ...
                <el-table-column label="啟用狀態" align="center" width="auto" prop="switch">
                    <template #default="scope">
                        <!-- <el-tag type="{{ scope.row.switch == 0 ? 'danger' : 'success' }}">{{ scope.row.switch == 0 ? '停用' : '啟用' }}</el-tag> -->
                        <el-tag effect="dark" :type="scope.row.switch == 0 ? 'danger' : 'danger'">{{ scope.row.switch == 0 ? '停用' : '啟用' }}</el-tag>
                    </template>
                </el-table-column>
                <el-table-column
                    label="操作"
